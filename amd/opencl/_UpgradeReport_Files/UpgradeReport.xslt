...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
  ...
  <xsl:template match="Projects" mode="ProjectOverview">
    ...
    <table>
      <tr>
        <th></th>
        <th _locID="ProjectTableHeader">專案</th>
        <th _locID="PathTableHeader">路徑</th>
        <th _locID="ErrorsTableHeader">錯誤</th>
        <th _locID="WarningsTableHeader">警告</th>
        <th _locID="MessagesTableHeader">訊息</th>
      </tr>
              ...
              <a>
                ...
                <xsl:choose>
                  <xsl:when test="@ProjectDisplayName = ''">
                    <span _locID="OverviewSolutionSpan">方案</span>
                  </xsl:when>
                  <xsl:otherwise>
    ...
    <tr>
      ...
      <td class="messageCell">
        ...
        <a _locID="ShowAdditionalMessages" href="#">
          ...
          顯示 <xsl:value-of select="@MessageCount"/> 其他訊息
        </a>
      </td>
    </tr>
  </xsl:template>
    ...
    <tr style="display: none">
      ...
      <td class="messageCell">
        ...
        <a _locID="HideAdditionalMessages" href="#">
          ...
          隱藏 <xsl:value-of select="@MessageCount"/> 其他訊息
        </a>
      </td>
    </tr>
  </xsl:template>
  ...
  <xsl:template match="Projects" mode="ProjectDetails">
    ...
    <xsl:for-each select="Project">
      ...
      <xsl:choose>
        <xsl:when test="@ProjectDisplayName = ''">
          <h3 _locID="ProjectDisplayNameHeader">方案</h3>
        </xsl:when>
        <xsl:otherwise>
          <h3>
            <xsl:value-of select="@ProjectDisplayName"/>
      ...
      <table>
        <tr>
          ...
          <th></th>
          <th class="messageCell" _locID="MessageTableHeader">訊息</th>
        </tr>
              ...
              <xsl:choose>
                ...
                <xsl:otherwise>
                  <td class="messageCell" _locID="NoMessagesRow">
                    <xsl:value-of select="@ProjectDisplayName"/> 未記錄任何訊息。
                  </td>
                </xsl:otherwise>
              </xsl:choose>
            </tr>
    ...
    <html>
      ...
      <body>
        <h1 _locID="ConversionReport">
          移轉報告 - <xsl:value-of select="Properties/Property[@Name='Solution']/@Value"/>
        </h1>

        <div id="content">
          <h2 _locID="OverviewTitle">概觀</h2>
          ...
          <h2 _locID="SolutionAndProjectsTitle">方案和專案</h2>

...
echoFlags :
	$(VERBOSE)echo LIB_ARCH = $(LIB_ARCH)
	$(VERBOSE)echo NVCCFLAGS = $(NVCCFLAGS)
	$(VERBOSE)echo CXX_ARCH_FLAGS = $(CXX_ARCH_FLAGS)
	$(VERBOSE)echo CXXFLAGS = $(CXXFLAGS)
	$(VERBOSE)echo CFLAGS = $(CFLAGS)
	$(VERBOSE)echo LINKFLAGS = $(LINKFLAGS)
	$(VERBOSE)echo LINK = $(LINK)
	$(VERBOSE)echo INCLUDES = $(INCLUDES)
	$(VERBOSE)echo COMMONFLAGS = $(COMMONFLAGS)
	$(VERBOSE)echo OPENGLLIB = $(OPENGLLIB)
	$(VERBOSE)echo LIB = $(LIB)
	$(VERBOSE)echo STATIC_LIB = $(STATIC_LIB)
	$(VERBOSE)echo TARGET = $(TARGET)
	$(VERBOSE)echo LINKLINE = $(LINKLINE)
	$(VERBOSE)echo OBJDIR = $(OBJDIR)
	$(VERBOSE)echo OBJS = $(OBJS)